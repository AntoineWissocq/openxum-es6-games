...
class Gui extends OpenXum.Gui {
    ...
    get_move() {
        ...
        if (this._engine.phase() === Sixth.Phase.PUT_PIECE) {
            move = new Sixth.Move(Sixth.MoveType.PUT_PIECE, this._engine.current_color(), this._selected_piece);
        }
        return move;
    }
    ...
    _draw_piece(letter, number, color, sixth) {
        ...
        let longitude = this._offsetX + long * this._deltaX + (this._deltaX/2);
